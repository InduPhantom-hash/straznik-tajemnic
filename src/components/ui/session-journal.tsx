        ...
        <div className="bg-[#16130f] border-b border-[#c9a227]/25 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4 relative z-20">
          ...
          <div className="flex gap-2 items-center">
            ...
            <Button
              ...
              className="bg-emerald-800/80 hover:bg-emerald-700/80 text-amber-400 border border-amber-500/50/40 font-serif"
            >
                          ...
                          <div>
                            <h4 className="text-lg font-serif font-bold text-amber-400 flex items-center gap-2">
                              ...
                              {entry.isAutoGenerated && (
                                <span className="text-[10px] bg-emerald-900/70 text-amber-400 border border-amber-500/50/30 px-1.5 py-0.5 rounded uppercase font-sans">
                                  Auto
                                </span>
                              )}
                            </h4>
