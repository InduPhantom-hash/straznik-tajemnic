...
export const EQUIPMENT_CATALOG: EquipmentTemplate[] = [
  ...
  },
  {
    ...
    aliases: ['Notebook & Pencil', 'Notes badawczy', 'Szkicownik', 'Notatnik'],
    category: 'document',
    visualTreatment: 'mundane',
    availableIn: ALL_ERAS,
  ...
  },
  {
    id: 'document.map',
    name: 'Mapa',
    aliases: ['Map', 'Mapy lotnicze regionu', 'Mapa regionu', 'Plany architektoniczne'],
    category: 'document',
    visualTreatment: 'mundane',
    availableIn: ALL_ERAS,
  ...
  },
  {
    id: 'document.diary',
    name: 'Dziennik',
    aliases: ['Journal/Diary', 'Dziennik', 'Pamiętnik', 'Notatnik z zapiskami'],
    category: 'document',
    visualTreatment: 'mundane',
    availableIn: ALL_ERAS,
