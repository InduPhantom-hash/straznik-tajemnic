                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between mt-3 pt-2 border-t border-brass/10">
                        ...
                        <button
                          ...
                          className="cursor-pointer bg-primary px-3 py-1.5 font-display text-[11px] font-semibold uppercase tracking-[0.16em] text-[#04110f] hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-45"
                        >
                          {unavailable ? 'Przypisana' : 'Wybierz'}
                        </button>
                      </div>
                    </div>
                  </div>
