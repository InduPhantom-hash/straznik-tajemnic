...
export function CharacterDevelopmentPanel({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="deco-corners relative border border-brass/40 bg-gradient-to-br from-[#1a1610] to-[#100d09] shadow-deco w-[80vw] h-[78vh] max-h-[85vh] overflow-hidden flex flex-col">
        {/* Header */}
