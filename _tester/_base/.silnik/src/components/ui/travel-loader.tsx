          ...
          (<div className="space-y-4">
            ...
            <div className="bg-zinc-800 rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-zinc-400">{t('durationLabel')}</p>
            ...
            {/* Route & Transport */}
            <div className="bg-zinc-800 rounded-lg p-4">
              <p className="text-sm text-zinc-400 mb-1">{t('routeLabel')}</p>
            ...
            {travelResult.risks.length > 0 && (
              <div className="bg-amber-900/30 border border-amber-700/50 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-medium text-amber-400">{t('risksLabel')}</p>
                </div>
            ...
            <p className="text-center text-zinc-400 text-sm">
              {t('costLabel')} <span className="text-emerald-400">{travelResult.cost}</span>
            </p>
            {/* Continue button */}
            <button
              onClick={onClose}
