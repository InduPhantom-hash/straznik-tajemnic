...
export interface ExtendedJournalEntry extends Omit<JournalEntry, 'type' | 'isBookmarked'> {
...
export function SessionJournal({
  ...
  const entries = useMemo(() => {
    const rawEntries = (character.journal || []) as unknown as ExtendedJournalEntry[];
