...
| Tablica Badacza | Węzły, połączenia, lightbox i trwałość. | `corkboard-investigation-board.tsx`, `Character.investigatorBoard`. | Kod, obrazy z istniejących wpisów. | Testy UI. `stable`: trwała siatka współrzędnych, sznurki dowodowe, Idea Roll. |
