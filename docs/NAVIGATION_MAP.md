...
graph TD
    ...
    character_wizard -->|Zapisz postać / Save character| session_zero
...
| Kreator postaci | Zapisz postać / Save character | Sesja Zero | `src/components/ui/character-wizard.tsx` |
