...
- **Kompendium Badacza & Kodeks Zasad (Mini-Obsidian):** Wbudowany w boczny pasek system wiedzy: instrukcja interfejsu, przewodnik po odgrywaniu w duchu Fiction First i Fail Forward, leksykon Mitów Cthulhu oraz Kodeks Zasad d100 Weird Fiction z lokalną wyszukiwarką podręcznika.
...
- **Purist d100 Weird Fiction Combat (pp. 102-117 Keeper Rulebook):** Dark Art Déco `OpposedMeleeCard` interface (Dodge vs Fight Back vs Combat Maneuvers), tie asymmetry (Dodge beats attack, Fight Back loses on tie), Build modifiers, Outnumbered bonus dice, and Dive for Cover against firearms.
...
- **Investigator Compendium & Rulebook (Mini-Obsidian):** Sidebar-integrated knowledge repository featuring UI atlas, Fiction First and Fail Forward roleplaying guide, Mythos lorebook, and d100 Weird Fiction rule index with local PDF search.
...
3. **Uszczelnienie Dossier i purystyczny Idea Roll d100 Weird Fiction (Faza 3 - PR #359, PR #360):**
...
4. **Puryzm Walki d100 Weird Fiction (Faza 4 - PR #361, PR #362):**
